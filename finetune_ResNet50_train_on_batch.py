...
# 因为ResNet50具有BN层,所以要关闭BN的计算,并使用默认的值
...
# x = GlobalAveragePooling2D()(base_model.get_layer('bn5c_branch2c').output)
...
# log = history.history
STEPS = 20000
log_file = './logs/finetune_ResNet50_logs.csv'
acc_file = './logs/finetune_ResNet50_acc.csv'
...
#model.save('./models/keras/finetune_ResNet50.h5')    
f_log.close()
f_acc.close()